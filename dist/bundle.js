...
var _ScoreBoard = __webpack_require__(29);
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      this.state.dice.forEach(function (die) {
        ...
        if (letter === 'Q') {
          _this2.state.board.push("Qu");
        } else {
          _this2.state.board.push(letter);
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { id: 'container' },
        _react2.default.createElement('img', { id: 'title', src: 'http://qumani.com/qdserve/boggle-logo.png' }),
        _react2.default.createElement(
          'div',
          { id: 'board' },
          this.state.board.map(function (letter, index) {
            return _react2.default.createElement(
              'div',
              { className: 'btn', onClick: _this3.clicked },
              _react2.default.createElement(
                'span',
                null,
                ' ',
